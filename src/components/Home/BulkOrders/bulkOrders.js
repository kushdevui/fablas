...
class BulkOrders extends Component{
    ...
    _valiate(){
        var errors = {}
        if(this.state.bulkOrder.fullName == ""){
            errors.fullName = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.companyName == ""){
            errors.companyName = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.companyAddress == ""){
            errors.companyAddress = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.phone == ""){
            errors.phone = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.email == ""){
            errors.email = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.city == ""){
            errors.city = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.country == ""){
            errors.country = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.category == ""){
            errors.category = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.quantity == ""){
            errors.quantity = "Please fill in the required fields";
        }
        if(this.state.bulkOrder.comments == ""){
            errors.comments = "Please fill in the required fields";
        }
        return errors;
    }
            ...
            <div className="row" id="bulk">
                ...
                <div className="row text-left">
                    <div className="col-lg-12 heading ">
                        ...
                        <p>{Object.keys(this.state.errors).length?"Please fill in the required fields":""}</p>
                    </div>
                </div>
