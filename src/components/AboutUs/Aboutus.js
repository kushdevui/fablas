...
"/>
                    <div className="row">
                        <div className="col-12 col-lg-3 res-item">
                            ...
                            <div className="pt-2 font-weight-bold">Sustainbility</div>
                        ...
                        <div className="col-lg-3 col-12 res-item">
                            ...
                            <div className="pt-2 font-weight-bold">Community Engagement</div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel <span>Read More</span></p>
                        </div>
                        <div className="col-lg-3 col-12 res-item">
                        <div className="res-icon col-lg-4 col-3">
                            ...
                            <div className="pt-2 font-weight-bold">Sponsorships & Partnerships</div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel, <span>Read More</span></p>
                        </div>
                        <div className="col-lg-3 col-12 res-item">
                        <div className="res-icon col-lg-4 col-3">
                            ...
                            <div className="pt-2 font-weight-bold">Rewards</div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel. <span>Read More</span></p>
                        </div>
                </div>
                </div>
